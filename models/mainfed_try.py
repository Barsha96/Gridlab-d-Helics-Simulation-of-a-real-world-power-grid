...
import helics as h
from math import pi
from github.simulation.models.publication_hub_try import PubHub
...
def assign_publication(fed, buildings, pubs, data, subs):
    ...
    for t in simulation_time:
        ...
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_voltage_A", "complex")
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_voltage_B", "complex")
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_voltage_C", "complex")  
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_current_A", "complex")
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_current_B", "complex")
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_current_C", "complex")         
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_power_A", "complex")
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_power_B", "complex")
        output = get_subscriptions(subs, timee, output, "R1", "msource", "measured_power_C", "complex")  
        ...
        output.to_csv("output_try.csv", index=False)
