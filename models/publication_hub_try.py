...
class PubHub:
    ...
    def register_subscription(self, subs):
        ...
        # config_file = "r1_tryoutconfig.json
        
        #for meter msource
        subid30 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_voltage_A", "")
        subs["R1/msource/measured_voltage_A"] = subid30

        subid31 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_voltage_B", "")
        subs["R1/msource/measured_voltage_B"] = subid31

        subid32 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_voltage_C", "")
        subs["R1/msource/measured_voltage_C"] = subid32

        subid33 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_current_A", "")
        subs["R1/msource/measured_current_A"] = subid33

        subid34 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_current_B", "")
        subs["R1/msource/measured_current_B"] = subid34

        subid35 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_current_C", "")
        subs["R1/msource/measured_current_C"] = subid35

        subid33 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_power_A", "")
        subs["R1/msource/measured_power_A"] = subid33

        subid34 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_power_B", "")
        subs["R1/msource/measured_power_B"] = subid34

        subid35 = h.helicsFederateRegisterSubscription(self.fed, "R1/msource/measured_power_C", "")
        subs["R1/msource/measured_power_C"] = subid35
